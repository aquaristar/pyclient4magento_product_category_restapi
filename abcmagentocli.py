...
class ABCMagentoRESTClient(object):
	MAGENTO_HOST = 'http://local.abcwarehouse.com'
	MAGENTO_API_BASE = '%s/api/rest/' % MAGENTO_HOST
	MAGENTO_LOGIN_URL = '%s/index.php/admin/oauth_authorize/index/' % MAGENTO_HOST
	CONSUMER_KEY = '5c03b8a9925a28db171914ddb5004991'
	CONSUMER_SECRET = '3dc7a5c8017b26356fd386e0368f0cc2'

	def __init__(self):
		self.username = "restuser"
		self.password = "wkduddk2012"
